...
The three scenario sections at the end deliberately break the pipeline by slowing down one stage, then show how to diagnose the backlog in Grafana and recover by scaling the bottleneck deployment.
...
#2 [internal] load metadata for registry.access.redhat.com/ubi9/openjdk-21-runtime:latest
#2 DONE 0.4s

#3 [internal] load metadata for registry.access.redhat.com/ubi9/openjdk-21:latest
#3 DONE 0.4s
...
#6 [builder 1/7] FROM registry.access.redhat.com/ubi9/openjdk-21:latest@sha256:cc8a30e9181b0135e6657ca3b824d7b32e4c7f6a664769ef641d4f7031339564
#6 resolve registry.access.redhat.com/ubi9/openjdk-21:latest@sha256:cc8a30e9181b0135e6657ca3b824d7b32e4c7f6a664769ef641d4f7031339564 0.1s done
#6 DONE 0.1s

#7 [stage-1 1/5] FROM registry.access.redhat.com/ubi9/openjdk-21-runtime:latest@sha256:ff0a095f96c1823453008aef23b98868f3bf723fa0497d68c2fb9b1a27884064
#7 resolve registry.access.redhat.com/ubi9/openjdk-21-runtime:latest@sha256:ff0a095f96c1823453008aef23b98868f3bf723fa0497d68c2fb9b1a27884064 0.1s done
#7 DONE 0.1s
...
#9 [stage-1 4/5] COPY --chown=185 --from=builder /build/target/quarkus-app/app/        /deployments/app/
#9 CACHED

#10 [stage-1 3/5] COPY --chown=185 --from=builder /build/target/quarkus-app/*.jar       /deployments/
#10 CACHED

#11 [builder 4/7] COPY pom.xml pom.xml
#11 CACHED

#12 [builder 7/7] RUN mvn package -DskipTests -q
#12 CACHED

#13 [builder 5/7] RUN mvn dependency:resolve-plugins dependency:resolve -q
#13 CACHED

#14 [builder 6/7] COPY src/ src/
#14 CACHED

#15 [builder 2/7] WORKDIR /build
#15 CACHED
...
#18 exporting manifest sha256:f3bbc97e9ef8f75346538fa4130332d5991aee722876e552b076563b522034fe done
#18 exporting config sha256:c7976b108b6d01d99e3ac4b179bbf59098428e9d9225a4d656a2cb78657dd624 done
#18 exporting attestation manifest sha256:27fcf35264e7bcd05ee3b1ce66d15f41433be8e1959acc20242db1bce8e06d3d 0.0s done
#18 exporting manifest list sha256:93e541e4762a320ddad85bb007e01176497a4dc4cf28b372f11a152796a21120 0.0s done
...
NAME: trust-manager
LAST DEPLOYED: Tue Sep 15 16:21:34 2026
...
NAME: prometheus
LAST DEPLOYED: Tue Sep 15 16:22:00 2026
...
pod/arkmq-org-broker-controller-manager-7446c69c4c-99lh7 condition met
pod/prometheus-grafana-578d4fd94-w8mmd condition met
pod/prometheus-kube-prometheus-operator-58ffbdf745-rf242 condition met
pod/prometheus-kube-state-metrics-599975f55f-9jpks condition met
pod/prometheus-prometheus-kube-prometheus-prometheus-0 condition met
pod/prometheus-prometheus-node-exporter-p7jxm condition met
```
...
```
```shell markdown_runner
delivery-service-app-binding-secret                                                   Opaque                                3      60s
order-generator-binding-secret                                                        Opaque                                3      5m31s
...
```
```shell markdown_runner
2026-09-15 15:31:09,072 INFO  [org.apache.qpid.jms.JmsConnection] (AmqpProvider :(167):[amqps://messaging-service.service-app-project.svc.cluster.local:61616]) Connection ID:799e1173-2f20-4889-9ad6-711b3cf43b3b:167 connected to server: amqps://messaging-service.service-app-project.svc.cluster.local:61616
2026-09-15 15:31:09,246 INFO  [order-generator] (Camel (camel-1) thread #1 - timer://order-generator) [generator] → ORDERS.NEW | orderId=ORD-de1990
2026-09-15 15:31:09,274 INFO  [org.apache.qpid.jms.JmsConnection] (AmqpProvider :(168):[amqps://messaging-service.service-app-project.svc.cluster.local:61616]) Connection ID:1c5115c8-bb10-4d13-838d-497b07f4b5dc:168 connected to server: amqps://messaging-service.service-app-project.svc.cluster.local:61616
2026-09-15 15:31:09,446 INFO  [order-generator] (Camel (camel-1) thread #1 - timer://order-generator) [generator] → ORDERS.NEW | orderId=ORD-9f9b79
2026-09-15 15:31:09,478 INFO  [org.apache.qpid.jms.JmsConnection] (AmqpProvider :(169):[amqps://messaging-service.service-app-project.svc.cluster.local:61616]) Connection ID:728e395f-7b42-444f-b0d4-1ded2ce2598e:169 connected to server: amqps://messaging-service.service-app-project.svc.cluster.local:61616
```
...
```
```shell markdown_runner
2026-09-15 15:31:09,118 INFO  [order-processor] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.NEW]) [processor] ← ORDERS.NEW | processing...
2026-09-15 15:31:09,219 INFO  [order-processor] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.NEW]) [processor] → ORDERS.PROCESSED | status=PROCESSED
2026-09-15 15:31:09,287 INFO  [order-processor] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.NEW]) [processor] ← ORDERS.NEW | processing...
2026-09-15 15:31:09,388 INFO  [order-processor] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.NEW]) [processor] → ORDERS.PROCESSED | status=PROCESSED
2026-09-15 15:31:09,488 INFO  [order-processor] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.NEW]) [processor] ← ORDERS.NEW | processing...
```
...
```
```shell markdown_runner
2026-09-15 15:31:09,255 INFO  [order-shipping] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.PROCESSED]) [shipping] → ORDERS.SHIPPED | status=SHIPPED
2026-09-15 15:31:09,401 INFO  [order-shipping] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.PROCESSED]) [shipping] ← ORDERS.PROCESSED | shipping...
2026-09-15 15:31:09,427 INFO  [order-shipping] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.PROCESSED]) [shipping] → ORDERS.SHIPPED | status=SHIPPED
2026-09-15 15:31:09,633 INFO  [order-shipping] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.PROCESSED]) [shipping] ← ORDERS.PROCESSED | shipping...
2026-09-15 15:31:09,659 INFO  [order-shipping] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.PROCESSED]) [shipping] → ORDERS.SHIPPED | status=SHIPPED
```
...
```
```shell markdown_runner
2026-09-15 15:31:09,291 INFO  [order-delivery] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.SHIPPED]) [delivery] → ORDERS.DELIVERED | status=DELIVERED
2026-09-15 15:31:09,436 INFO  [order-delivery] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.SHIPPED]) [delivery] ← ORDERS.SHIPPED | delivering...
2026-09-15 15:31:09,462 INFO  [order-delivery] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.SHIPPED]) [delivery] → ORDERS.DELIVERED | status=DELIVERED
2026-09-15 15:31:09,681 INFO  [order-delivery] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.SHIPPED]) [delivery] ← ORDERS.SHIPPED | delivering...
2026-09-15 15:31:09,707 INFO  [order-delivery] (Camel (camel-1) thread #1 - JmsConsumer[ORDERS.SHIPPED]) [delivery] → ORDERS.DELIVERED | status=DELIVERED
```
...
```
```shell markdown_runner
HFGvvXXfoq3sVLGiNqkCCVsUNJhY4rOk80V85l8t
```
...
kubectl get endpoints messaging-service-metrics -n service-app-project
```
```shell markdown_runner
NAME                        AGE
messaging-service-monitor   1s
NAME                        ENDPOINTS          AGE
messaging-service-metrics   10.244.0.19:8888   1s
...
Everything is already running. Open the **"Artemis Broker - Memory & Queue Analysis"** dashboard and confirm the pipeline is flowing at 5 msg/s.

Under normal conditions you should see:

| Panel | Expected value |
|---|---|
| Container vs JVM vs Queue Memory | Container Working Set and JVM Heap stable; Queue Persistent Data growing slowly |
| Current Queue Breakdown | `ORDERS.DELIVERED` top row with growing message count; other queues near zero |

A growing `ORDERS.DELIVERED` queue is expected — `master-sink` is intentionally disabled. `ORDERS.DELIVERED` accumulates at approximately 5 messages/sec; after about 20 seconds it should contain roughly 100 messages — a useful sanity check that the full pipeline is flowing.
...
The **Current Queue Breakdown** table shows `ORDERS.PROCESSED` message count climbing while the other queues stay flat. This is the bottleneck made visible.
...
Because `CONSUMER_CONCURRENCY=1`, the five shipping replicas create five JMS consumers on `ORDERS.PROCESSED`. The **Current Queue Breakdown** table shows the `ORDERS.PROCESSED` message count dropping back toward zero as the backlog drains.
...
# Delete cluster-scoped resources created for this tutorial
# (ClusterIssuers are not namespace-scoped — they survive namespace deletion)
